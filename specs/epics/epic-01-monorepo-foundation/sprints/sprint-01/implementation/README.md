...
#### 2. [CODE_REVIEW_SESSION_PROMPT.md](./CODE_REVIEW_SESSION_PROMPT.md) ⏳ **PENDING**
...
**Status**: ⏳ Pending (run after E2E tests)
**Recommended Model**: Claude Opus

---

#### 3. [CONTINUE_SESSION_PROMPT.md](./CONTINUE_SESSION_PROMPT.md) ✅ COMPLETED
